...
import (
	...
	crdinformers "kubesphere.io/kubesphere/pkg/client/informers/externalversions/storage/v1alpha1"
...
func NewController(
	...
	// Set up an event handler for when StorageClassCapability CRD resources change
...
func (c *StorageCapabilityController) enqueueSccap(obj interface{}) {
	var key string
	var err error
...
func (c *StorageCapabilityController) enqueuePcap(obj interface{}) {
...
func (c *StorageCapabilityController) handleScObject(obj interface{}) {
...
func (c *StorageCapabilityController) Run(threadiness int, stopCh <-chan struct{}) error {
	...
	if !isValid {
		klog.V(0).Infof("StorageCapability controller minimal kubernetes version %s, skipped.", MinimalKubernetesVersion)
		return nil
	}
...
func (c *StorageCapabilityController) IsValidKubernetesVersion() (bool, error) {
